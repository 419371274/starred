...
- [ionic-native-transitions](https://github.com/shprink/ionic-native-transitions) - [Unmaintained][Seeking maintainers] Native transitions (iOS & Android) for Ionic Framework
